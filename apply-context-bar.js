...
function updateJs(jsPath) {
  ...
  const callWithCompact = 'o9.default.createElement(ft1,{session:$,usedTokens:$.usageData.value.totalTokens,contextWindow:$.usageData.value.contextWindow-$.usageData.value.maxOutputTokens-13000,onCompact:z,buttonClassName:o$.usageButtonV2})';
  const callNew = 'o9.default.createElement(ft1,{session:$,usedTokens:$.usageData.value.totalTokens,contextWindow:$.usageData.value.contextWindow-$.usageData.value.maxOutputTokens-13000,buttonClassName:o$.usageButtonV2})';
  if (js.includes(callOld)) js = js.replace(callOld, callNew);
  else if (js.includes(callWithCompact)) js = js.replace(callWithCompact, callNew);
